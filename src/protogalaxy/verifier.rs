use std::iter;
use ff::BitViewSized;
use crate::plonk::{Error, vanishing};
use crate::plonk::permutation::VerifyingKey;
use crate::transcript::read_n;
use crate::utils::arithmetic::compute_inner_product;

/// Given an aggregated VK, a list of instances and the folding error term,
/// this function evaluates the identites and check that they correspond to the
/// expected error.
fn verify_identites_folded_proof<F, CS, T>(
